...
const projects = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=640&h=420&fit=crop&auto=format",
    tech: [
      "Next.js",
      "Node.js",
      "TypeScript",
    ...
    mn: {
      sub: "Казах Төте жазу бичгийн дасгалын платформ",
      problem:
        "Төте жазуг дижитал орчинд системтэй сурах, бичих хурд ба зөв байдлаа хэмжих хүртээмжтэй хэрэгсэл хомс.",
      solution:
        "Үг, өгүүлбэрийн дасгал, санамсаргүй текстийн API, WPM/accuracy хэмжилт болон виртуал keyboard visualization бүхий платформ бүтээсэн.",
      contribution:
        "Сургалтын interaction, typing metrics, keyboard visualization болон frontend/backend урсгалыг хэрэгжүүлсэн.",
      proves:
        "Тусгай бичгийн системийг ойлгомжтой UX, бодит цагийн хэмжилт болон API дизайнтай холбох чадвар.",
    },
    en: {
      sub: "A Kazakh Tote Jazu typing practice platform",
      problem:
        "Learners lacked an accessible way to practice the script systematically and measure speed and accuracy.",
      solution:
        "Built word and sentence drills, a randomized-text API, live WPM and accuracy metrics, and a visual Tote keyboard.",
      contribution:
        "Implemented the learning interaction, typing metrics, keyboard visualization, and frontend/backend flow.",
      proves:
        "Ability to turn a specialized writing system into clear UX backed by real-time measurement and API design.",
    },
  },
  {
    title: "TRIPLE",
    ...
    image:
      "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=640&h=420&fit=crop&auto=format",
    tech: [
      "NestJS",
      "React",
      "Material UI",
    ...
    mn: {
      sub: "Responsive сургалтын full-stack платформ",
      problem:
        "Сургалтын контент, хэрэглэгч болон эрхийн урсгалыг desktop, mobile аль алинд ойлгомжтой хүргэх шаардлагатай.",
      solution:
        "React ба Material UI интерфэйсийг NestJS, Prisma, PostgreSQL, JWT authentication бүхий backend-тэй холбосон.",
      contribution:
        "Responsive frontend, authentication, API integration болон relational өгөгдлийн давхарга дээр ажилласан.",
      proves:
        "Орчин үеийн UI-г secure backend болон relational data model-той цэвэр холбох чадвар.",
    },
    en: {
      sub: "A responsive full-stack learning platform",
      problem:
        "Learning content, users, and access flows needed a clear experience across desktop and mobile.",
      solution:
        "Connected a React and Material UI frontend to a NestJS backend with Prisma, PostgreSQL, and JWT authentication.",
      contribution:
        "Worked across responsive frontend, authentication, API integration, and the relational data layer.",
      proves:
        "Ability to connect modern UI with a secure backend and a clean relational model.",
    },
  },
  {
    title: "BLINKCV",
    ...
    image:
      "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=640&h=420&fit=crop&auto=format",
    tech: ["React", "Vite", "TypeScript", "Tailwind CSS", "Responsive UI"],
    mn: {
      sub: "Хурдан CV бүтээх responsive веб хэрэгсэл",
      problem:
        "Ажил горилогчид техникийн мэдлэггүйгээр цэвэр, мэргэжлийн CV хурдан бэлтгэх хэрэгтэй.",
      solution:
        "Form-driven засварлалт, шууд preview болон дэлгэцийн хэмжээнд зохицох интерфэйстэй React апп бүтээсэн.",
      contribution:
        "Component architecture, form interaction, preview layout болон responsive styling-ийг хэрэгжүүлсэн.",
      proves:
        "Хэрэглэгчийн ажлыг цөөн алхамтай, ойлгомжтой frontend бүтээгдэхүүн болгох чадвар.",
    },
    en: {
      sub: "A responsive tool for creating polished CVs quickly",
      problem:
        "Job seekers needed a simple way to produce a clean CV without design or technical expertise.",
      solution:
        "Built a React experience around form-driven editing, immediate preview, and responsive layouts.",
      contribution:
        "Implemented component architecture, form interactions, preview layout, and responsive styling.",
      proves:
