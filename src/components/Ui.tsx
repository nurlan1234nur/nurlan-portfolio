...
export function SkillGroup({
  ...
  return (
    <div>
      <p className="mb-6 font-mono text-[9px] tracking-widest text-slate-500">
        {label}
      </p>
...
export function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="min-w-28">
      ...
      <p className="mt-1 font-mono text-[8px] tracking-widest text-slate-500">
        {label}
      </p>
    </div>
  )
...
export function Capability({
  ...
  return (
    <article className="border-slate-200 py-8 md:border-r md:px-7 md:first:pl-0 md:last:border-r-0">
...
export function Timeline({
  ...
  return (
    <div className="relative pb-12 pl-8 before:absolute before:-left-1 before:top-1 before:h-2 before:w-2 before:rounded-full before:border before:border-accent before:bg-[#020403]">
